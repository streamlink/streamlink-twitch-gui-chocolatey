...
Install-ChocolateyZipPackage `
	...
	-Checksum       "5ec366432b0030bb466396ea1eca41cf7bf0ebf4f2472f5dcc5455ed477b518c" `
	-ChecksumType   "sha256" `
	-Url64bit       "$($downloadPath)streamlink-twitch-gui-$packageVersion-win64.zip" `
	-Checksum64     "06d8f342b795206f0ee4e3ebf0308a57d47427501b810dfe28ca34ad643c08ce" `
